...
@class SCLocationAdldentityController; @class FeedViewController; @class SCSingleFriendStoriesViewingSession; @class SCProfileViewController_DEPRECATED; @class SCLocationController; @class SCStoriesViewController; @class SCChatViewControllerV3; @class SCOperaVideoLayerViewController; @class SCBaseMediaOperaPresenter; @class SCOperaPageViewController; @class SCText; @class SCStoryAdInsertionController; @class SettingsViewController; @class SCChatViewControllerV2; @class SCChatBaseViewController; @class SCStoriesConfiguration; @class SCLocationUnlockablesController; @class SCLocationPreCacheFetcher; @class SCLocationSharedStoriesController; @class SCProfileViewController; @class SCDrawingView; @class AVCameraViewController; @class SCOperaArrowLayerViewController; @class SCSingleDiscoverEditionSession; @class SCBroadcastTweaks; @class SCCaptionBigTextPlusView; @class SCSnapPlayController; @class SCCameraTimer; @class SCLocationWeatherController; @class SCChatV3MessageActionHandler; @class AMPEvent; @class SCGroupStoryPrepostViewController; @class Story; @class SCFeedViewController; @class SCOperaImageLayerViewController; @class NSBundle; @class SCOperaPage; @class SCCaptionDefaultTextView; @class SCPreviewDefaultFilterDataProvider; @class EphemeralMedia; @class SendViewController; @class PreviewViewController; @class SCLocationDataFetcher; @class SCBaseMediaMessage; @class SCManagedVideoCapturer; @class SCOperaArrowLayerView; @class SCChatMainViewController; @class UIApplication; @class SCTwoRowsTilesViewController; @class SCDiscoverLogger; @class SCIdentityTweaks; @class Manager; @class SCLocationMobStoriesController; @class SCMapViewController; @class SCChatTypingHandler; @class SCChatViewController; @class SCStoriesAutoAdvanceAdsManager; @class SCCameraOverlayView; @class MainViewController; @class undle; @class SCAppDeIegate; @class SCBasicSearchViewController; @class SCZeroDependencyExperimentAccessor; 
...
#line 133 "/Users/imokhles/Documents/SCOSource/XcodeProject/IMSnap/IMSnap/IMSnap.xm"
...
static void _logos_method$STORY_HOOK$SCOperaPageViewController$_addChildLayerVC$(_LOGOS_SELF_TYPE_NORMAL SCOperaPageViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1) {
...
static id _logos_method$STORY_HOOK$SCOperaPageViewController$sc_currentFriendStoriesViewingSession(_LOGOS_SELF_TYPE_NORMAL SCOperaPageViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
...
static id _logos_method$STORY_HOOK$SCOperaImageLayerViewController$circleProgressBarHandler(_LOGOS_SELF_TYPE_NORMAL SCOperaImageLayerViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
...
static id _logos_method$STORY_HOOK$SCOperaVideoLayerViewController$circleProgressBarHandler(_LOGOS_SELF_TYPE_NORMAL SCOperaVideoLayerViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    return objc_getAssociatedObject(self, @selector(circleProgressBarHandler));
}
...
static __attribute__((constructor)) void _logosLocalCtor_d136531d(int __unused argc, char __unused **argv, char __unused **envp) {
